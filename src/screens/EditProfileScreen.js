...
export default function EditProfileScreen({navigation}) {
  ...
  const choosePhotoFromLibrary = () => {
    ...
    <View style={styles.container}>
        ...
        <Text style={{fontFamily: 'Montserrat-ExtraBold', fontWeight: 'bold', fontSize: 32, marginTop: 15, color: '#2c2c2c'}}>Edit</Text>
        <Text style={{fontFamily: 'Montserrat-Italic-VariableFont_wght', fontWeight: 'bold', fontSize: 32,  marginBottom: 20, color: '#2c2c2c'}}>Profile</Text>
